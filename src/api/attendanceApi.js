...
// starting on weekStart ("M/d/yyyy", a Monday). If email is given, also
// shares a standalone copy of it with that address and emails them a
// link (blank just writes the tab). Director-only. Returns { success:
// true, message, tabName, reportUrl, sharedCopyUrl } or { success:
// false, error }. Throws (with err.name === 'AbortError' on timeout) on
// network failure.
